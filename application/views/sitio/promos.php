...
<p>&nbsp;</p>
		...
		<h4 class="latest-text w3_latest_text">PROMOCION 1</h4>


<div style="text-align: center;">
	 <img src="<?php echo base_url();?>assets/img/PROMO1.jpg" style="width:500px; height:300px; ">
	  <p>&nbsp;</p>
	  <hr>
<div />
...
<hr>
			...
			<h4 class="latest-text w3_latest_text">PROMOCION 2</h4>
			<div style="text-align: center;">
	 <img src="<?php echo base_url();?>assets/img/PROMO2.jpg" style="width:500px; height:300px; ">
	  <p>&nbsp;</p>
	  </div>
<div ">
	Restaurant formato Cine-Café & Sushi / Tienda de Arriendo y Venta de películas (Videoclub) / Exhibición de películas
...
<hr>
				...
				<h4 class="latest-text w3_latest_text">PROMOCION 3</h4>
				<div style="text-align: center;">
	 <img src="<?php echo base_url();?>assets/img/PROMO3.jpg" style="width:500px; height:300px; ">
	  <p>&nbsp;</p>
	  <hr>
<div >
	Restaurant formato Cine-Café & Sushi / Tienda de Arriendo y Venta de películas (Videoclub) / Exhibición de películas
