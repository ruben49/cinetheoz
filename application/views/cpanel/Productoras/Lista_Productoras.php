  ...
  <!-- /.content-wrapper -->
  	...
  	<div  class="modal fade bd-example-modal-lg" id="crearProductora" tabindex="-1" role="dialog" aria-labelledby="crearCarrera" aria-hidden="true">
	  <div class="modal-dialog modal-lg">
	    <div class="modal-content">
	      	
	 	  <div class="modal-header">
	        <h2 align="center"><span class="fa fa-paperclip fa-1x"></span> Crear Nueva Productora</h2>   
<!-- 	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	        ...
	        <div class="modal-body">
                    <div class="form-group">
                        <div class="col-lg-3">
                            <label>Nombre de la Productora</label> <input
    ...
    <script src="<?php echo base_url();?>assets/js/Mantenedores/Productoras.js"></script>